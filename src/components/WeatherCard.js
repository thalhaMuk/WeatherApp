...
import { setWithExpiry, formatWeatherDateTime, weatherIcons } from '../utils/constants';
        ...
        <div className="Container" style={{ backgroundColor: randomColor }}>
          ...
          <div className="BottomContainer">
            ...
            <div className="BottomMiddleContainer">
              ...
              <h3 className="TinyText">
                <strong>{weatherData.wind.speed} m/s {weatherData.wind.deg} Degree</strong>
              </h3>
            </div>
            <div className="headerDivider"></div>
